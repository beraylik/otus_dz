...
public class SwiftSetManipulator : SetManipulator {
  ...
  public func setupWithObjectCount(_ objectCount: Int) -> TimeInterval {
  ...
  public func add1Object() -> TimeInterval {
    return addObjects(1)
  }
  
  public func add5Objects() -> TimeInterval {
    return addObjects(5)
  }
  
  public func add10Objects() -> TimeInterval {
  ...
  public func remove1Object() -> TimeInterval {
    return removeObjects(1)
  }
  
  public func remove5Objects() -> TimeInterval {
    return removeObjects(5)
  }
  
  public func remove10Objects() -> TimeInterval {
  ...
  public func lookup1Object() -> TimeInterval {
    return lookupObjects(1)
  }
  
  public func lookup10Objects() -> TimeInterval {
