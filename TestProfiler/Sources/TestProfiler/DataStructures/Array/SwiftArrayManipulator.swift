...
public class SwiftArrayManipulator: ArrayManipulator {
  ...
  public func setupWithObjectCount(_ count: Int) -> TimeInterval {
  ...
  public func insertNewObjectAtBeginning() -> TimeInterval {
  ...
  public func insertNewObjectInMiddle() -> TimeInterval {
  ...
  public func addNewObjectAtEnd() -> TimeInterval {
    let next = nextElement()
    let time = Profiler.runClosureForTime() {
  ...
  public func removeFirstObject() -> TimeInterval {
  ...
  public func removeMiddleObject() -> TimeInterval {
    let half = Float(intArray.count) / Float(2)
    let middleIndex = Int(ceil(half))
  ...
  public func removeLastObject() -> TimeInterval {
  ...
  public func lookupByIndex() -> TimeInterval {
  ...
  public func lookupByObject() -> TimeInterval {
